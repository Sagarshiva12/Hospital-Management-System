...
public class editDoctor extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Connection conn=DriverManager.getConnection("jdbc:mysql://localhost:3306/hospital","root","Sagar123*#");
        
        String sql = "update `doctors_record` SET `Doctors_Name`='"+dname+"',`Specialization`='"+dspec+"'WHERE id='"+did+"'";
